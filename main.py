...
def main():
    ...
    for round_idx in range(NUM_ROUNDS):
        ...
        # Global Evaluation on Validation Set (Acc + F1 for journal)
    ...
    # ---- Re-evaluate the best model for final summary on TEST set ----
    ...
    # ---- Graphs ----
    # Pass acc list for plotting (existing plotting expects list of floats)
